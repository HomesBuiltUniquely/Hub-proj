                ...
                <div className="hidden md:flex justify-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-8">
                            ...
                            {/* Right CTA */}
                            <button onClick={handleGetEstimate} className="bg-[#ef0101] text-[18px] tracking-wide hover:bg-[#ebd457]  text-white px-4 py-2 rounded-4xl manrope  mr-15 -mt-12 shadow-lg shadow-black/50 hover:shadow-2xl transform hover:-translate-y-0.5 active:translate-y-0 active:shadow-lg transition-shadow duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/60">GET FREE ESTIMATE</button>
                        </div>

export function Featurespro() {
  return (
    <div className="min-h-[600px] md:min-h-[800px] py-15 px-4 sm:px-6 lg:px-8 xl:px-20">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl text-center lg:text-center gilda-display-regular mb-10 sm:mb-12 lg:mb-16 xl:mb-20 text-amber-950 lg:ml-[6%] xl:ml-[8%]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-[1800px] mx-auto">
        {/* 10-Years Warranty */}
        <div className="border-2 border-[#DDCDC1] w-full h-full min-h-[200px] sm:min-h-[220px] md:min-h-[250px] lg:min-h-[280px] rounded-3xl p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
          <div className="flex justify-between items-start h-full">
            <div className="flex flex-col h-full justify-between">
              <div className="text-xm sm:text-2xl md:text-3xl font-medium mb-4 sm:mb-6 gilda-display-regular  text-amber-950">10-Years Warranty</div>
              <p className="tracking-wider text-sm sm:text-base md:text-lg font-medium">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              className="size-8 sm:size-10 md:size-12 fill-[#DDCDC1] flex-shrink-0 ml-4">
        ...
        <div className="border-2 border-[#DDCDC1] w-full h-full min-h-[200px] sm:min-h-[220px] md:min-h-[250px] lg:min-h-[280px] rounded-3xl p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
          <div className="flex justify-between items-start h-full">
            <div className="flex flex-col h-full justify-between">
              <div className="text-xm sm:text-2xl md:text-3xl font-medium mb-4 sm:mb-6 gilda-display-regular text-amber-950">0% EMI</div>
              <p className="tracking-wider text-sm sm:text-base md:text-lg font-medium">
        ...
        <div className="border-2 border-[#DDCDC1] w-full h-full min-h-[200px] sm:min-h-[220px] md:min-h-[250px] lg:min-h-[280px] rounded-3xl p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
          <div className="flex justify-between items-start h-full">
            <div className="flex flex-col h-full justify-between">
              <div className="text-xm sm:text-2xl md:text-3xl font-medium mb-4 sm:mb-6 gilda-display-regular text-amber-950">Factory Finish Interiors</div>
              <p className="tracking-wider text-sm sm:text-base md:text-lg font-medium">
        ...
        <div className="border-2 border-[#DDCDC1] w-full h-full min-h-[200px] sm:min-h-[220px] md:min-h-[250px] lg:min-h-[280px] rounded-3xl p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
          <div className="flex justify-between items-start h-full">
            <div className="flex flex-col h-full justify-between">
              <div className="text-xm sm:text-2xl md:text-3xl font-medium mb-4 sm:mb-6 gilda-display-regular text-amber-950">34 Days Delivery</div>
              <p className="tracking-wider text-sm sm:text-base md:text-lg font-medium">

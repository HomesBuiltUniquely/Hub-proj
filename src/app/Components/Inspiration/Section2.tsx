...
// **************************temporarily used untill images are provided*****************************************
...
const topCategories = ["Kitchen", "Bedroom", "Living Room", "Wardrobe", "Kids Room"];
const middleCategories = ["Dinning Room", "Pooja Unit", "False ceiling", "Wall Decor", "Study Room"];
const bottomCategories = ["Space Saving", "Door Design", "Crockery Unit", "Home Bar"];
...
const allCategories = [...topCategories, ...middleCategories, ...bottomCategories];
  ...
  return (
    <>
      ...
      <div className="block md:hidden w-full px-3 py-3 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <div className="w-full max-w-[425px] bg-white rounded-xl shadow-lg p-3 mt-2">
            {images[0] && (
              <div className="mb-3">
                <img
                  src={images[0].src}

  ...
  return (
    ...
    <div>
      ...
      <div className="desktop-1280 w-full">
        <div className="min-h-[750px] max-w-[1280px] mx-auto pt-20 px-8">
          {/* Top Section: Headline + Form */}
          <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-start justify-between gap-12 pt-12 pb-8 bg-white rounded-3xl">
            {/* Left: Heading and subtext */}
            ...
            <form
              ...
              className="md:w-[500px] bg-transparent space-y-8 -mt-8 mr-6"
            >
              {/* First & Last Name */}

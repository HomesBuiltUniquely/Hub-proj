...
const Locations: React.FC = () => (
  <div>
    ...
    <section className="desktop-2560 -mt-105 px-5">
    ...
    <section className="desktop-1920 -mt-105 px-20">
      <div className="w-full mx-auto h-[525px] rounded-3xl overflow-hidden shadow-lg bg-[url('/bn.jpg')] bg-cover bg-center relative">
        <div className="bg-black/50 py-20 px-12">
          <h2 className="text-white text-4xl manrope mb-1 pl-6">Our Locations</h2>
          <p className="text-white text-2xl mb-10 pl-7 manrope-medium">
            Find HUB location near you.

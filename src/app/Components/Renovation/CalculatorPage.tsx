...
export default function RenovationCalculatorPage() {
    ...
    function handelSubmit() {
        router.push('/home-renovation-in-bangalore/Calculator');
    }
                    ...
                    <div className="rounded-3xl bg-white flex justify-between items-center px-15 py-10">
                        ...
                        <div className="flex justify-end flex-1">
                            <div className="w-[500px] h-[500px] bg-[#F1F2F6] rounded-3xl shadow-xl p-10 flex justify-center flex-col items-center">
                                <img src="/calimages.png" alt="Estimate Icon" className="w-[120px] h-[120px] mt-2" />
                                ...
                                <button className="w-full h-[55px] bg-red-600 rounded-xl hover:bg-red-700 mt-5 flex justify-center items-center gap-3" onClick={handelSubmit}>

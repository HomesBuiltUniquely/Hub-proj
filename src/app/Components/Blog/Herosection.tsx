...
`}</style>
    ...
    >
      ...
      <div className="flex items-center justify-between px-8 py-4">
        ...
        <button className="bg-orange-100 text-black px-4 py-2 rounded-xl font-semibold shadow">
          GET FREE ESTIMATE
        </button>
      </div>
    ...
    <div
      className="desktop-1280 w-full h-[700px] mx-auto mt-4 rounded-3xl overflow-hidden shadow-md bg-cover bg-center relative"
      style={{ backgroundImage: "url('/bn.jpg')" }}
    >
      {/* Navbar */}
      <div className="flex items-center justify-between px-6 py-4">
        <img src="LOGO.png" className="w-[80px] h-[35px]" />
        <div className="hidden md:flex gap-8 text-xs font-semibold text-white tracking-widest">
          <a href="#">HOME</a>
          <a href="#">SERVICES</a>
          <a href="#">EXPLORE ROOMS</a>
        </div>
        <button className="bg-orange-100 text-black px-3 py-1.5 rounded-lg font-semibold shadow text-sm">
          GET FREE ESTIMATE
        </button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center pt-20 pb-10 text-white text-center">
        ...
        <p className="text-base font-medium mb-6 drop-shadow-lg w-[500px] max-w-[90%]">
          Get inspired to live a more beautiful and happy life at home.
          Our mission is to show how we are making each home more beautiful
          with easy-life tips and ideas for every budget.
        </p>
        <div className="flex gap-3">
          <button className="bg-yellow-300 text-black px-5 py-2 rounded-2xl font-semibold shadow">
            Subscribe Now
          </button>
        </div>
      </div>

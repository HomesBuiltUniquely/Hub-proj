    ...
    <div className="w-full">
      ...
      <div onClick={handleClick}> <Image src="/redlogo.png" alt="HUB Interior Logo" width={250} height={250} className="w-[230px] h-[250px] ml-9 mt-4" /></div>
       ...
       <div className="desktop-1440">
        ...
        <div className="hidden md:block w-[1400px] h-[900px] mx-auto  rounded-3xl overflow-hidden  bg-cover  bg-center relative" style={{ backgroundImage: "url('/bgimgblog.png')" }}>
          {/* Navbar */}
          ...
          <div className="flex flex-col items-start justify-start pt-24 pb-20 text-white text-left mt-70 ml-20">
            <h1 className="w-[1200px] text-5xl lg:text-6xl manrope mb-3 drop-shadow-lg">

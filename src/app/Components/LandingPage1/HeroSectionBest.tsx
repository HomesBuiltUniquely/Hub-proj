...
export default function HeroSections() {
    ...
    try {
      ...
      (async () => {
        try {
          ...
          console.warn(
            "Failed to POST to https://hows.hubinterior.com/v1/MetaLead",
            err,
          );
        }
      })();
  ...
  const handleFinalSubmit = async (verificationStatus = "UNVERIFIED") => {
    ...
    try {
      ...
      // On verified submission, also notify MetaLead so backend can upgrade UNVERIFIED -> VERIFIED.
      if (verificationStatus === "VERIFIED") {
        (async () => {
          try {
            ...
            console.warn(
              "Failed to POST verified update to https://hows.hubinterior.com/v1/MetaLead",
              err,
            );
          }
        })();

      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="block lg:hidden">
          ...
          <div className="relative w-full h-[420px] sm:h-[420px] mb-0 overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10 pb-64">
              <h1 className="text-white text-[28px] manrope top-5 text-left leading-tight drop-shadow-lg">Best Interior Designers in <span className="text-red-500">Banglore</span></h1>
              <p className="text-white text-base text-left font-medium drop-shadow top-3 pt-1">Transforming Bangalore homes with personalized<br/>interiors that reflect your lifestyle.</p>
            </div>
          </div>

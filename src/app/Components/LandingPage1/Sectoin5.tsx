  ...
  return (
    <div>
          ...
          <div className="flex mt-24 mr-20">
            <div className='mx-auto' >
              <div className='relative '>
                <div
                  className="relative bg-[#ef0101] w-[400px] h-[250px]  ml-20 rounded-[2rem]"
      ...
      <div className='desktop-1280 hidden lg:block'>
        <div className="w-screen h-[900px] bg-white">
          <div className="pt-10 text-center text-6xl manrope-medium">Complete Interior Solution by HUB</div>
          <div className="flex mt-24 justify-center -ml-20 px-5">
            <div className='mx-auto' >
              <div className='relative'>
                <div
                  className="relative bg-[#ef0101] w-[400px] h-[250px]  ml-20 rounded-[2rem]"
      ...
      {/* mobile */}
      <div className='lg:hidden w-auto h-[1420px]  bg-white mt-10'>

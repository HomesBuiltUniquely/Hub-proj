...
return(
    <div className="">
        ...
        <h1 className="w-full text-4xl manrope-medium tracking-wide text-left mb-8 mt-2 pl-4">
            Our Interior Solution
        </h1>
        </div>
    ...
    <li className="manrope-medium">
    Living Room ( TV Unit + Partition + Art Work + False Ceiling with Electrical)
    </li>
    <li className="manrope-medium">

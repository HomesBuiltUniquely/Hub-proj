        ...
        {steps.map((step, index) => (
          <React.Fragment key={index}>
            <div className="flex flex-col items-center text-center w-20">
              ...
              <p
                className={`mt-2 text-xs manrope transition-all duration-300 ${currentStep >= index ? "text-gray-800" : "text-gray-400"}`}
              >
                {step}
              </p>
            </div>
...
const Step2Rooms: React.FC<StepProps> = ({ formData, setFormData }) => {
  ...
  return (
    <div className="text-center">
      ...
      <div className="hidden lg:block">
        <h2 className="text-2xl font-bold text-gray-800 mb-10">
          Which rooms would you like to design?
        </h2>
        <div className="space-y-4 max-w-md mx-auto">
          {roomOptions.map((room) => {
            const count = formData.rooms?.[room] || 0;
            const minCount =
              room === "Bedroom" ? 2 : room === "Kitchen" ? 1 : 0;
            return (
              <div
                key={room}
...
const Step3WardrobeMeasurement: React.FC<StepProps> = ({
  formData,
  setFormData,
}) => {
  ...
  const wardrobeTypes = [
    {
      ...
      image: "/Slide.jpg",
      description:
        "Sliding doors glide smoothly along a metal rail to save valuable floor space.",
      desc: "Perfect for adding style to compact or modern interior.",
    },
    {
      name: "Swing",
      image: "/Swing.jpg",
      description:
        "Hinged doors that open outward for clear access and improved storage visibility.",
      desc: "A timeless budget-friendly choices suits every home.",
    },
  ];
      ...
      case 0: // Wardrobe Type Selection
        return (
          <div>
            ...
            <div className="hidden lg:block">
              ...
              <div className="flex gap-6 max-w-4xl mx-auto">
                {wardrobeTypes.map((type) => (
                  <div
                    key={type.name}
                    className="flex-1 border rounded-lg shadow-md overflow-hidden"
                  >
                    <img
                      src={type.image}
                      alt={type.name}
            ...
            {/* Mobile Version */}
            <div className="lg:hidden">
              <h3 className="text-center text-lg font-bold text-gray-800 mb-4 px-4">
                Select Wardrobe Type
              </h3>
          ...
          <div className="text-center">
            ...
            <div className="hidden lg:block">
              <h3 className="text-xl font-bold text-gray-800 mb-6">
                Select Dimensions for {formData.wardrobe?.type} Wardrobe
              </h3>
                  ...
                  <div className="flex justify-center gap-3 flex-wrap">
                    {sizeOptions.map((opt) => (
                      <button
                        key={opt}
                        onClick={() => {
                          handleOptionClick("height", opt);
                        }}
                        className={`py-3 px-6 border rounded-lg font-semibold transition-colors w-[90px] ${formData.wardrobe?.height === opt ? "bg-red-500 text-white border-red-500" : "bg-white text-gray-700 hover:border-red-400"}`}
                      >
                        {opt}
                      </button>
                    ))}
            ...
            {/* Mobile Version */}
            <div className="lg:hidden">
              <h3 className="text-lg font-bold text-gray-800 mb-4 px-4">
                Select Dimensions for {formData.wardrobe?.type} Wardrobe
              </h3>
                  ...
                  <div className="flex justify-center gap-2 flex-wrap">
                    {sizeOptions.map((opt) => (
                      <button
                        ...
                        className={`py-2 px-3 border rounded-lg font-semibold transition-colors w-[70px] touch-manipulation ${formData.wardrobe?.height === opt ? "bg-red-500 text-white border-red-500" : "bg-white text-gray-700 hover:border-red-400 active:bg-gray-50"}`}
                      >
                        {opt}
                      </button>
                    ))}
      ...
      {slide > 0 && (
        <div className="flex justify-center items-center mt-8 md:mt-12 pt-6 md:pt-8 border-t px-4">
          <button
            ...
            disabled={slide === 0}
            className="font-bold text-gray-500 hover:text-red-500 disabled:text-gray-300 mr-4 md:mr-8 text-sm md:text-base"
          >
            Back
          </button>
          <div className="flex space-x-2">
            {[0, 1].map((s) => (
              <div
                key={s}
                className={`w-2 h-2 rounded-full ${slide === s ? "bg-red-500" : "bg-gray-300"}`}
              ></div>
            ))}
          </div>
          <button
            ...
            disabled={slide === 1}
            className="font-bold text-gray-500 hover:text-red-500 disabled:text-gray-300 ml-4 md:ml-8 text-sm md:text-base"
          >
            Next
          </button>
        </div>
                  ...
                  return (
                    <div
                      ...
                      className={`relative p-3 border-2 rounded-lg cursor-pointer transition-all touch-manipulation ${
                        isSelected
                          ? "border-red-500 bg-red-50"
                          : "border-gray-200 bg-gray-50 hover:border-red-300 active:bg-gray-100"
                      }`}
                    >
                      <div
                        className={`absolute top-2 right-2 w-4 h-4 border-2 rounded-full flex items-center justify-center ${
                          isSelected ? "border-red-500" : "border-gray-400"
                        }`}
                      >
                        {isSelected && (
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                {kitchenSizes.map((opt) => (
                  <button
                    key={opt}
                    onClick={() => {
                      handleOptionClick("size", opt);
                      setSlide(2);
                    }}
                    className={`py-3 px-6 border rounded-lg font-semibold transition-colors text-sm ${formData.kitchen?.size === opt ? "bg-red-500 text-white border-red-500" : "bg-white text-gray-700 hover:border-red-400"}`}
                  >
                    {opt}
                  </button>
                ))}
              ...
              <div className="flex justify-center gap-2 flex-wrap px-4">
                {kitchenSizes.map((opt) => (
                  <button
                    ...
                    className={`py-2 px-3 border rounded-lg font-semibold transition-colors text-xs touch-manipulation ${formData.kitchen?.size === opt ? "bg-red-500 text-white border-red-500" : "bg-white text-gray-700 hover:border-red-400 active:bg-gray-50"}`}
                  >
                    {opt}
                  </button>
                ))}
            ...
            <div className="hidden lg:block">
              ...
              <div className="grid grid-cols-2 gap-6 max-w-2xl mx-auto">
                {kitchenUnits.map((unit) => {
                  const isSelected = formData.kitchen?.units?.includes(
                    unit.name,
                  );
                  return (
                    <div
                    ...
                    >
                      <div
                        className={`absolute top-4 right-4 w-6 h-6 border-2 rounded flex items-center justify-center ${isSelected ? "border-red-500" : "border-gray-400"}`}
                      >
                        {isSelected && (
              ...
              <div className="grid grid-cols-1 gap-3 max-w-sm mx-auto px-4 w-[250px]">
                {kitchenUnits.map((unit) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`absolute top-2 right-2 w-4 h-4 border-2 rounded flex items-center justify-center ${isSelected ? "border-red-500" : "border-gray-400"}`}
                      >
                        {isSelected && (
...
const Step5Material: React.FC<StepProps> = ({ formData, setFormData }) => {
  ...
  const finishOptions = [
    ...
    {
      name: "Membrane [Seamless And Affordable Luxury]",
      image: "/membrane.png",
    },
      ...
      case 0: // Material Type Selection
        return (
          <div className="text-center">
                  ...
                  return (
                    ...
                    >
                      ...
                      <ul className="list-disc pl-5 text-gray-600 text-sm text-left space-y-1">
                        {getDescriptionBullets(material.description).map(
                          (item, idx) => (
            ...
            {/* Mobile Version */}
            <div className="lg:hidden">
              <h2 className="text-lg font-bold text-gray-800 mb-4 px-4">
                Select Material Type
              </h2>
              <div className="grid grid-cols-1 gap-3 max-w-sm mx-auto px-4 w-[250px]">
                {materialTypes.map((material) => {
        ...
        <div className="grid grid-cols-2 gap-6 max-w-3xl mx-auto">
          {collections.map((c) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute top-3 right-3 w-5 h-5 border-2 rounded flex items-center justify-center ${isSelected ? "border-red-500" : "border-gray-400"}`}
                >
                  {isSelected && (
    ...
    <div>
      ...
      <div className="flex justify-center items-center mt-8 md:mt-12 pt-6 md:pt-8 border-t px-4">
        ...
        <button
          ...
          disabled
          className="font-bold text-gray-300 ml-4 md:ml-8 text-sm md:text-base"
        >
          Next
        </button>
      </div>
...
export default function CalculatorSetup() {
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      setIsFormSubmitting(
        (e as CustomEvent<{ isSubmitting: boolean }>).detail.isSubmitting,
      );
    };
    window.addEventListener("calculator:submitting", handler);
    return () => window.removeEventListener("calculator:submitting", handler);
  }, []);

  const steps = [
    "BHK TYPE",
    "Rooms To Design",
    "Wardrobe Measurement",
    "Kitchen Measurement",
    "Other Units",
    "Material finish",
    "Submit Form",
  ...
  const isStepValid = (stepIndex: number) => {
    switch (stepIndex) {
      case 0:
        return Boolean(
          formData.bhkType &&
          ["2 BHK", "3 BHK", "4 BHK and More"].includes(formData.bhkType),
        );
      case 1:
        return Boolean(
          formData.rooms && Object.keys(formData.rooms).length > 0,
        );
      case 2:
        return Boolean(formData.wardrobe?.type && formData.wardrobe?.height);
      case 3:
        return Boolean(
          formData.kitchen?.layout &&
          formData.kitchen?.size &&
          formData.kitchen?.units &&
          formData.kitchen.units.length > 0,
        );
      case 4:
        return Boolean(
          formData.collections?.selections &&
          formData.collections.selections.length > 0,
        );
      case 5:
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 4:
        return (
          <Step5Collections formData={formData} setFormData={setFormData} />
        );
      case 5:
    ...
    <div className="bg-gray-50 min-h-screen flex flex-col items-center justify-center font-sans">
      ...
      <header className="absolute top-0 left-0 w-full flex justify-between items-center">
        ...
        <div className="hidden lg:flex justify-between items-center w-full p-6">
          <Link href="/">
            <img src="/hub.png" alt="logo" className="w-[150px] h-[60px]"></img>
          </Link>
        ...
        <div className="hidden lg:block mt-24">
          ...
          <footer className="flex justify-between items-center mt-8 px-2">
            ...
            <button
              ...
              disabled={isNextDisabled() || isFormSubmitting}
              className="bg-red-500 text-white font-bold py-3 px-10 rounded-lg shadow-md hover:bg-red-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-base min-w-[100px]"
              data-calc-finish-btn={
                currentStep === steps.length - 1 ? true : undefined
              }
            >
        ...
        <div className="lg:hidden mt-20 p-2">
          ...
          <footer className="flex justify-between items-center mt-6 px-2">
            ...
            <button
              ...
              disabled={isNextDisabled() || isFormSubmitting}
              className="bg-red-500 text-white font-bold py-2 px-6 rounded-lg shadow-md hover:bg-red-600 active:bg-red-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-sm touch-manipulation min-w-[80px]"
              data-calc-finish-btn={
                currentStep === steps.length - 1 ? true : undefined
              }
            >

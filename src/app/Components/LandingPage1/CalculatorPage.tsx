    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="lg:hidden h-[500px]">
                ...
                <div className="px-4">
                    <div className="w-full max-w-sm mx-auto h-auto border-1 rounded-3xl border-[#ef0101] mt-8 p-6">
                        ...
                        <button className="w-full h-12 sm:h-14 bg-[#ef0101] rounded-2xl mt-2" onClick={handelSubmit}>
                            <div className="flex justify-center items-center gap-2">
                                <p className="text-white text-sm sm:text-base text-xl manrope">Calculate</p>

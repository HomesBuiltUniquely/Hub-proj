...
const ContactHeader: React.FC = () => (
  <div className="w-[1400px] h-[800px] mx-auto mt-4 rounded-3xl overflow-hidden shadow-md bg-cover bg-center relative" style={{ backgroundImage: "url('/bn.jpg')" }}>
    ...
    <div className="flex flex-col items-center justify-center pt-24 pb-20 text-white text-center mt-30 pr-220">
      <h1 className="text-5xl lg:text-6xl font-extrabold mb-6 drop-shadow-lg">Modular Kitchen</h1>
      <p className="text-lg font-medium mb-8 drop-shadow-lg pr-20">Any questions you have can be resolved here.</p>
      <div className="flex gap-4">
        <button className="bg-yellow-300 text-black px-6 py-3 rounded-full font-semibold shadow mr-80">Lets Connect</button>
      </div>
    </div>
  </div>
);

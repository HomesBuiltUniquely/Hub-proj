...
const BedroomHeroSimple: React.FC = () => (
  ...
  <div className="flex flex-col items-center justify-center pt-24 pb-20 text-white text-center mt-30 pr-220">
    <h1 className="text-5xl lg:text-5xl font-extrabold mb-6 drop-shadow-lg pr-50">Bedroom</h1>
    <p className="text-lg font-medium mb-8 drop-shadow-lg pr-10">Any questions you have can be resolved here.</p>

    ...
    <div>
      ...
      <div className="desktop-2560">
        ...
        <div className="hidden md:block w-full h-[900px] overflow-hidden relative">
          {/* Background Image */}
          <div className="absolute inset-0 w-full h-full bg-cover bg-center" style={{ backgroundImage: "url('https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/All_HeroSection/bedroom.jpg')" }}></div>

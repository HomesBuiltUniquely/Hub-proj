    ...
    return (
        <>
            ...
            <div className="desktop-wrapper">
                ...
                <div className="w-[700px] h-auto min-h-[380px] py-5 bg-gray-100 rounded-3xl flex justify-between items-center mx-auto px-3 mt-20 shadow-lg">

...
const ContactHeader: React.FC = () => {
  ...
  return (
    ...
    <div>
      ...
      <div>
        <div className="desktop-2560  hidden md:block w-[1400px] h-[900px] mx-auto  rounded-3xl overflow-hidden  bg-cover  bg-center relative" style={{ backgroundImage: "url('https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/WallInterior%20H.png')" }}>
          {/* Navbar */}
      ...
      {/* 1920 version */}
       ...
       <div className="desktop-1920">
        ...
        <div className="hidden md:block w-[full] max-w-[1920px] h-[950px] mx-auto  rounded-3xl overflow-hidden  bg-cover bg-center  relative" style={{ backgroundImage: "url('https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/WallInterior%20H.png')" }}>
          {/* Bg- image */}

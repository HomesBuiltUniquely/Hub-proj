...
const ContactHeader: React.FC = () => {
  ...
  return (
    ...
    <div>
      ...
      <div>
        <div className="desktop-2560  hidden md:block w-[1400px] h-[900px] mx-auto  rounded-3xl overflow-hidden  bg-cover  bg-center relative" style={{ backgroundImage: "url('https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/wall+decor/wall_decor_header/wall_decor_interior_design.jpg')" }}>
          {/* Navbar */}
      ...
      <div className="desktop-1920">
        ...
        <div className="hidden md:block w-[full] max-w-[1920px] h-[950px] mx-auto  rounded-3xl overflow-hidden  bg-cover bg-center  relative" style={{ backgroundImage: "url('https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/wall+decor/wall_decor_header/wall_decor_interior_design.jpg')" }}>
          {/* Bg- image */}
      ...
      <div className="desktop-1280">
        <div className="hidden md:flex justify-center  bg-[#f9f9f9]">
          ...
          <div
            ...
            style={{ backgroundImage: "url('https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/wall+decor/wall_decor_header/wall_decor_interior_design.jpg')" }}
          >
            {/* Navbar */}
      ...
      <div className="md:hidden px-4 mk-mobile-360 mobile-360plus mt-3 mb-10">
        <div className="relative h-[450] w-[full] ">
          ...
          <div className="absolute inset-0 rounded-4xl overflow-hidden">
            <Image
              src="https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/wall+decor/wall_decor_header/wall_decor_interior_design.jpg"
              alt="Wall Decor"
              fill
              priority

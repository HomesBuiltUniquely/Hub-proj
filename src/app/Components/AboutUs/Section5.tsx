...
const Section5 = () => {
  ...
  const timeline = [
    ...
    { year: "2025 – Expanding Horizons", content: "Opened a new Experience Centre in JP Nagar, Bengaluru." },
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Opened a new Experience Centre in JP Nagar, Bengaluru.',
    },

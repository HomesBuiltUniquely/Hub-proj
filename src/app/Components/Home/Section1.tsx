...
export default function npSection1() {
  return (
    <div>
      <style jsx>{`
      ...
      <div className="home-desktop desktop-2560 w-full max-w-8xl h-[900px] bg-[#F1F2F6] lg:rounded-b-4xl mt-10 hidden md:block ">
        <h1 className="text-[26px] text-center w-[1080px] mx-auto mt-5 lg:mx-auto leading-[1.45] manrope-medium">
          HUB Interior is India&#39;s leading and most innovative interior
          design company. We specialize in tailor-made solutions from modular
          kitchen interiors to luxury villa interiors designed to suit your
          lifestyle and professional needs. No compromises. Just personalized
          interiors that fit you perfectly.
        </h1>
        <div className="bg-[#F1F2F6] w-[1250px] h-auto  grid grid-cols-4 mt-10 gap-30 mx-85">
          <div className="grid grid-rows-2  mt-10 gap-6">
            <div className="w-[330px] h-[400px] bg-red-500 rounded-3xl">
              <Image
                src="https://yzmnmgrkugecsfnsmhib.supabase.co/storage/v1/object/public/videosmp4/img4.jpg"
                alt="Section 1"
                width={330}
                height={400}
                className="rounded-3xl h-[410px] object-cover"
              />
            </div>
            <div className="w-[330px] h-[250px] bg-[#DDCDC1] rounded-3xl pt-10 pl-6 mt-3">
              <div className="text-[50px] leading-[1.15] manrope-bold">10</div>
              <h3 className="type-h3 manrope-semibold pt-3">Years Warranty</h3>
              <p className="type-body manrope pt-2 w-[250px]">
                Every material we use and every detail we craft comes backed
                with a 10-year warranty — because timeless interiors deserve
                timeless trust..
              </p>
            </div>
          </div>
          <div className="grid grid-rows-2  mt-10">
            ...
            <div className="w-[330px] h-[400px] bg-red-00 rounded-3xl -mt-35">
              <Image
                src="https://yzmnmgrkugecsfnsmhib.supabase.co/storage/v1/object/public/videosmp4/img5.jpg"
                alt="Section 1"
                width={330}
                height={400}
                className="rounded-3xl h-[410px] object-cover"
          ...
          <div className="grid grid-rows-2 mt-10 gap-6">
            <div className="w-[330px] h-[400px] bg-red-500 rounded-3xl">
              <Image
                src="https://yzmnmgrkugecsfnsmhib.supabase.co/storage/v1/object/public/videosmp4/img6.jpg"
                alt="Section 1"
                width={330}
                height={400}
                className="rounded-3xl h-[410px] object-cover"
            ...
            <div className="w-[330px] h-[250px] bg-[#DDCDC1] rounded-3xl pt-10 pl-6  mt-3">
              ...
              <h3 className="type-h3 manrope-semibold pt-3">Finish</h3>
              <p className="type-body manrope pt-2 w-[250px]">
                Enjoy flawless factory-finish interiors with premium
                craftsmanship, seamless edges, and unmatched detailing — all
      ...
      <div className="home-desktop desktop-1920 hidden md:block mx-20">
        <div className="w-full h-[900px] bg-[#F1F2F6] lg:rounded-b-4xl mt-10">
          <h1 className="text-[24px] text-center w-[1040px] mx-auto mt-5 leading-[1.45] manrope-medium">
            HUB Interior is India&#39;s leading and most innovative interior
            design company. We specialize in tailor-made solutions from modular
            kitchen interiors to luxury villa interiors designed to suit your
            lifestyle and professional needs. No compromises. Just personalized
          ...
          <div className="bg-[#F1F2F6] w-full max-w-[1920px] mx-auto grid grid-cols-4 gap-10 place-items-center">
            <div className="grid grid-rows-2  mt-10 gap-4">
              ...
              <div className="w-[325px] h-[250px] bg-[#DDCDC1] rounded-3xl pt-8 pl-6 mt-3">
                <div className="text-[50px] leading-[1.15] manrope-bold">
                  10
                </div>
                <h3 className="type-h3 manrope-semibold pt-3">
                  Years Warranty
                </h3>
                <p className="type-body manrope pt-2 w-[250px]">
                  Every material we use and every detail we craft comes backed
      ...
      <div className="home-desktop desktop-1280 w-full max-w-[1240px] h-[900px] bg-[#F1F2F6] lg:rounded-b-4xl mt-15 mx-auto px-5">
        <h1 className="text-[20px] text-center mx-auto leading-[1.45] manrope-medium">
          HUB Interior is India&#39;s leading and most innovative interior
          design company. We specialize in tailor-made solutions from modular
          kitchen interiors to luxury villa interiors designed to suit your
          lifestyle and professional needs. No compromises. Just personalized
        ...
        <div className="bg-[#F1F2F6] w-full h-auto grid grid-cols-4 place-items-center mt-5">
          <div className="grid grid-rows-2  mt-10 gap-3">
            ...
            <div className="w-[285px] h-[250px] bg-[#DDCDC1] rounded-3xl pt-8 pl-3 mt-3">
              <div className="text-[50px] leading-[1.15] manrope-bold">10</div>
              <h3 className="type-h3 manrope-semibold pt-3">Years Warranty</h3>
              <p className="type-body manrope pt-2 w-[250px]">
                Every material we use and every detail we craft comes backed
      ...
      <div className="block md:hidden">
        <div className="w-full min-h-[700px] bg-[#F1F2F6] mt-6 px-4">
          ...
          <div className="mt-15">
            ...
            <div className="-mt-10 typography-h2 wulkan-display-bold pl-4 sm:pl-6">
              {" "}
              why choose us
            </div>
            <p className="text-left text-sm sm:text-base mt-4 manrope-medium pl-4 sm:pl-6 max-w-sm">
              We dont just deliver projects, we deliver experiences that last.
            </p>
          </div>

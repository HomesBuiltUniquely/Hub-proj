...
export default function Section2() {
  ...
  const roomCards = [
    ...
    },
    {
      title: "Living Room",
      image:
        "https://yzmnmgrkugecsfnsmhib.supabase.co/storage/v1/object/public/videosmp4/img4.jpg",
      link: "/",
    },
    {
  ...
  const desktopMaxSlide =
    Math.ceil(roomCards.length / desktopCardsPerView) - 1.5;
                    ...
                    >
                      <div className="relative w-80 h-96 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div className="absolute bottom-0 left-0 p-6">
                          <h3 className="text-white text-xl manrope mb-2">
                            {room.title}
                          </h3>
                        </div>
          ...
          <div className="bg-[#F1F2F6] py-8 px-4">
            <div className="mb-8">
              ...
              <h1 className="typography-h2 wulkan-display-bold text-gray-800 text-left pl-4 -mt-9">
                ...
                <div className="text-3xl">start yours here</div>
              </h1>
            </div>

  ...
  const serviceCards = [
    {
      ...
      description:
        "Efficient layouts and space-saving designs crafted to fit kitchens, wardrobes, and storage — blending style with everyday functionality.",
      image: "/bed3.jpg",
      link: "/GetEstimate",
      borderColor: "",
    },
    {
      ...
      description:
        "From concept to completion, we provide complete interior solutions — covering every room with design, execution, and finishing.",
      image: "/bed1.jpg",
      link: "/GetEstimate",
      borderColor: "",
    },
    {
      ...
      description:
        "Luxury interiors thoughtfully built to balance modern design, comfort, and personal expression. elevating everyday lifestyle",
      image: "/bed4.jpg",
      link: "/GetEstimate",
      borderColor: "",
    },
  ...
  return (
    <div>
              ...
              >
                {serviceCards.map((service, index) => (
                  <div key={index} className="flex-shrink-0 w-[416px]">
                    <div
                      className={`bg-white rounded-3xl overflow-hidden hover:shadow-xl duration-300 h-auto flex flex-col`}
                    >
                      <div className="relative h-96">
                        <img
                          src={service.image}
      ...
      <div className="block md:hidden bg-[#F1F2F6] py-10">
        ...
        <h1 className="typography-h2 wulkan-display-bold text-left px-5 -mt-9 pl-8">
          All interior service, One destination
        </h1>

      ...
      <div className="block md:hidden">
        ...
        <div className="mobile-small w-full max-w-[360px] h-[610px] relative bg-gray-100 rounded-[35px] overflow-hidden mx-auto px-3 -mt-7">
          ...
          <div className="w-full max-w-[360px] relative bg-gray-100 mt-1 rounded-[35px] overflow-hidden mx-auto">
            <div className="relative z-20 flex items-center justify-between ">
              <img
                src="/redlogo.png"
                className="w-[110px] h-[95px] -mb-1 -ml-3"
              ></img>
            </div>
          </div>
          ...
          <div className="relative w-full max-w-[360px] mx-auto -mt-14">
            ...
            <div className="absolute bottom-[140px] left-0 w-[300px] text-left text-4xl manrope text-white wulkan-display-bold ml-4">
              {mobileTexts[Math.min(currentSlide, 2)]}
            </div>
            ...
            <button
              onClick={handleGetEstimate}
              className="absolute bottom-[50px] left-0 bg-[#FF0000] text-nowrap text-white px-7 py-2 rounded-4xl ml-4 manrope text-sm h-[38px] w-[210px] shadow-lg shadow-black/50 hover:shadow-2xl transform hover:-translate-y-0.5 active:translate-y-0 active:shadow-lg transition-shadow duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/60"
            >
        ...
        <div className="mobile-large max-w-[425px] h-auto relative bg-gray-100 rounded-[35px] px-3 overflow-hidden mx-auto">
          ...
          <div className="relative max-w-[425px] mx-auto -mt-18">
            ...
            <button
              onClick={handleGetEstimate}
              className="absolute bottom-[50px] left-0 bg-[#FF0000] text-white text-nowrap px-7 py-2 rounded-4xl ml-20 manrope shadow-lg shadow-black/50 hover:shadow-2xl transform hover:-translate-y-0.5 active:translate-y-0 active:shadow-lg transition-shadow duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/60"
            >
              {heroSlides[Math.min(currentSlide, 2)].buttonText}
            </button>
          </div>

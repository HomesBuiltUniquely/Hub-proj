                            ...
                            <div className="flex flex-row text-white gap-16 justify-center">
                                ...
                                <div className="mt-12">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Link href="/"><p className="text-[14px] manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Life at HUB</p></Link>
                                        <Link href="/"><p className="text-[14px] manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Career</p></Link>
                                        <Link href="/ContactUs"><p className="text-[14px] manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Contact us</p></Link>
                                    </div>
                                </div>
                                ...
                                <div className="mt-12">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Link href="/"><p className="text-[14px] manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Reviews</p></Link>
                            ...
                            <div className="flex flex-col md:flex-row text-white gap-12 justify-center">
                                ...
                                <div className="mt-10">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Link href="/"><p className="text-sm manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Life at HUB</p></Link>
                                        <Link href="/"><p className="text-sm manrope-medium hover:text-teal-200 transition-colors duration-300 cursor-pointer">Career</p></Link>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Link href="/"><p className="text-xs manrope-medium hover:text-teal-200 transition-colors cursor-pointer pt-2">Career</p></Link>
                                    <Link href="/"><p className="text-xs manrope-medium hover:text-teal-200 transition-colors cursor-pointer pt-2">Customer Review</p></Link>
                                    <Link href="/"><p className="text-xs manrope-medium hover:text-teal-200 transition-colors cursor-pointer pt-2">Project</p></Link>
                                    <Link href="/Blog"><p className="text-xs manrope-medium hover:text-teal-200 transition-colors cursor-pointer pt-2">Blogs</p></Link>
                                    <Link href="/"><p className="text-xs manrope-medium hover:text-teal-200 transition-colors cursor-pointer pt-2">Life at hub</p></Link>
                                </div>
                            </div>
                        ...
                        <div className="border-t border-gray-600 pt-6">
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <div className="text-center">
                                    <p className="text-xs text-gray-300 manrope-medium">Privacy Policy Terms & Conditions</p>
                                </div>
                            </div>
                        </div>
                    </div>

...
export default function Footer() {
    ...
    return (
        <div>
            ...
            <div className="home-desktop aboutus-footer-3xl-container hidden 3xl:block mb-2">
            ...
            <div className="home-desktop aboutus-footer-2xl-section hidden 2xl:block 3xl:hidden mb-2">
            ...
            <div className="home-desktop aboutus-footer-xl-section hidden xl:block 2xl:hidden mb-2">
                            ...
                            <div className="flex flex-row text-white gap-20 justify-center">
                                ...
                                <div className="mt-15 mr-10">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer">Home Automations</p>
                                        <p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer">Home Interior Price Calculator</p>
                                        <Link href='/Inspiration'><p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer">Inspiration</p></Link>
                                ...
                                <div className="mt-15 mr-10">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <a href="/LivingRoom">            <p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer mt-3">Living Room</p></a>
                                        <a href="/KidsRoom">              <p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer mt-3">Kids Room</p></a>
                                        <a href="/PoojaUnit">           <p className="text-[14px] manrope-medium hover:text-[#ebd657] transition-colors duration-300 cursor-pointer mt-3">Pooja Unit</p></a>
            ...
            <div className="home-desktop aboutus-footer-lg-section hidden lg:block xl:hidden mb-2">
            ...
            <div className="home-desktop aboutus-footer-md-section hidden md:block lg:hidden mb-2">

...
const FRANCHISE_OPTIONS = [
  {
    title: "FICO/FOCO (Franchise Invested Company Operated/Company Operated Company Operated)",
    details: [
      "Tier 1 cities",
      "ROI 200% in 1 year",
      "Investment 35L - 50L",
  ...
  <div className="min-h-screen bg-[#f1f2f6] w-[1400px] h-auto mx-auto mt-4">
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-10 md:flex-row justify-between px-8 md:px-20 w-full flex-1 py-10 md:py-0">
        ...
        {/* Right: Form */}
        <div className="md:w-[500px] h-[550px] w-full bg-black/60 rounded-xl shadow-lg px-7 py-8 self-center">
          ...
          <form className="space-y-4">
            <div className="flex gap-3">
              ...
              <input
                required
                placeholder=""
                className="w-[440px] px-4 py-2 rounded border mt-4 bg-[#f2f2f6]/70"
                type="text"
              />
              </div>
              <div className="">
            ...
            <button
              type="submit"
              className="w-full bg-red-600 text-white font-bold py-2 rounded mt-4 hover:bg-red-700 transition"
            >
             Submit
            </button>
          </form>

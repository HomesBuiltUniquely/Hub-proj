                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            <h2 className="text-2xl font-bold text-gray-900 pt-4">The Living Room Highlight - The TV Unit</h2>
                              <div className="relative w-[380px] h-[580px] rounded-xl overflow-hidden mt-3 ml-50">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img1.png" alt="Royal Tulip Villa TV unit" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 pt-6">A Kitchen That Wows</h2>
                             <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img2.png" alt="Royal Tulip Villa kitchen" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 pt-6">The Handwash + Crockery Unit</h2>
                               <div className="relative w-[420px] h-[480px] rounded-xl overflow-hidden mt-3 ml-50">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img3.png" alt="Royal Tulip Villa kitchen" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-145 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img4.png" alt="Royal Tulip Villa wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img5.png" alt="Royal Tulip Villa false ceiling and wall panels" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img6.png" alt="Royal Tulip Villa walk-in wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img7.png" alt="Royal Tulip Villa walk-in wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[380px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-60">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog10img8.png" alt="Royal Tulip Villa walk-in wardrobe" className="w-full h-full object-cover" />
                            </div>

				...
				<article className="bg-white rounded-2xl shadow-lg overflow-hidden">
					<div className="p-8">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							...
							<p>Before we dive into the details,want a quick glimpse of the transformation? <a href="https://www.instagram.com/reel/DOEbFfqE5jy/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA%3D%3D" className="text-red-500 hover:text-red-600 font-semibold">Check out Mr. Akhil’s home here →</a></p>
							...
							<div>
							<img src="/lin.png" alt="Bhoo Aabharana home" className="rounded-xl" />
							</div>
							...
							<div className="relative w-[500px] h-[500px] md:h-96 rounded-xl overflow-hidden mt-3 ml-30">
								<img src="/blog1img1.png" alt="Devotion area" className="w-full h-full object-cover" />
							</div>
							...
							<div className="relative w-[500px] h-[500px] md:h-96 rounded-xl overflow-hidden mt-3 ml-30">
								<img src="/blog1img2.png" alt="Modern kitchen" className="w-full h-full object-cover" />
							</div>
							...
							<div className="relative w-[500px] h-[500px] md:h-96 rounded-xl overflow-hidden mt-3 ml-30">
								<img src="/blog1img3.png" alt="Modern kitchen" className="w-full h-full object-cover" />
							</div>
							...
							<div className="relative w-[500px] h-[500px] md:h-96 rounded-xl overflow-hidden mt-3 ml-30">
								<img src="/blog1img4.png" alt="Bedroom makeover" className="w-full h-full object-cover" />
							</div>
							...
							<div className="relative w-[500px] h-[500px] md:h-96 rounded-xl overflow-hidden mt-3 ml-30">
								<img src="/blog1img5.png" alt="Living room" className="w-full h-full object-cover" />
							</div>

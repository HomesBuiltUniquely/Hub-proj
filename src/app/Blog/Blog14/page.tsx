        ...
        <div className="min-h-screen bg-[#f1f2f6] manrope-medium">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <article className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-8">
                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Top 5 Living Room Design Themes for Modern Urban Homes</h1>
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <p>Lighting is equally important. Layered lighting using a mix of ceiling, floor and table lamps can change the mood of the room instantly. During the day, natural light can illuminate the space, while in the evening, soft lamps create a calm environment.</p>

                            <h2 className="text-2xl font-bold text-gray-900 pt-6">Why Trends Matter?</h2>
                            <p>Following <span className="font-black text-black">top interior design trends 2025</span> is not about copying styles blindly. It is about understanding what works for urban living. Trends like modular seating, wall-mounted storage, multi-functional furniture and minimalist art help solve the challenge of compact spaces while keeping them modern. They make everyday living easier, smarter and more enjoyable.</p>
                            <p><span className="font-black text-black">Modern home décor ideas in Bengaluru</span> often include clever storage, flexible layouts and textures that feel natural yet stylish. The focus is on creating rooms that match real life instead of just looking perfect for a photo.</p>

                            <h2 className="text-2xl font-bold text-gray-900 pt-6">Smart Solutions with Professional Help</h2>
                            <p>If transforming your living room feels overwhelming, expert guidance can make all the difference. <Link href="/" className="text-red-500 hover:text-red-600 font-semibold">HUB Interior</Link> is India’s leading interior design company offering tailor-made solutions from modular kitchens to luxury villas. We specialise in creating master bedrooms and living spaces in Bengaluru with best layouts, ambient lighting and thoughtful storage. With over 5,000 projects delivered, a 10-year warranty and a 34-day fast-track promise, we ensure your interiors are personalized, practical and beautiful.</p>
                            <p>Hiring professionals helps in choosing the right furniture, colours and layouts that work for your lifestyle. With HUB Interior, you can achieve stylish <span className="font-black text-black">urban home interior design</span> that makes your daily life comfortable while giving your home a modern and elegant look.</p>
                        </div>
                    </div>
                </article>
            </div>

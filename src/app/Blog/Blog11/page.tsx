        ...
        <div className="min-h-screen bg-[#f1f2f6] manrope-medium">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <article className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-8">
                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Which Kitchen Layout Suits You Best – L-Shaped, U-Shaped, or Island Kitchen?</h1>
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">The reason why we at <span className="font-black text-black">HUB Interior</span> understand the need to put the customer first before going on with the kitchen layout.</p>
                            <p className="text-gray-700 leading-relaxed mb-8">Today, we&#39;re diving into three of the most popular kitchen setups: L-shaped, U-shaped, and island kitchens. However, this is not just your normal guide! We&#39;ll break down who they&#39;re for, the perks, the quirks, and more. Spoiler alert: each one has its own personality (yes, kitchens totally have personalities).</p>
                        </div>

                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            <h2 className="text-2xl font-bold text-gray-900 pt-4">A Dive Into Three Kitchen Layouts: L-Shaped, U-Shaped, and Island Kitchen</h2>
                            
                            <h3 className="text-xl font-semibold text-gray-900 pt-4">L-Shaped Kitchen Layout</h3>
                            ...
                            <p>An additional tip: think about your family, entertaining habits, and whether you&#39;ll ever need extra prep space to know better which layout fits your needs.</p>

                            <h2 className="text-2xl font-bold text-gray-900 pt-6">Wrapping Up</h2>
                            <p>Here&#39;s the tea: picking a kitchen layout isn&#39;t just about what looks cute on Instagram. It&#39;s about how you cook, who cooks with you, your budget, and how much space you really need.</p>
                            <p>And if you&#39;re still confused, contact <span className="font-black text-black">HUB Interior</span> today to get expert advice on which layout fits your space the best. Now that you know the secret to choosing the best layout, tell us, which kitchen style are you falling for?</p>
                            <p>Need help with designing? The <span className="font-black text-black">best interior designer in Bangalore</span> is just a click away.</p>
                        </div>
                    </div>
                </article>
            </div>

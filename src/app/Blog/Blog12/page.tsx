                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog12img1.png" alt="Interactive chalkboard cupboard" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog12img2.jpg" alt="Interactive chalkboard cupboard" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>You can even add hinged panels or sliding doors that “lift off” when opened, making it feel like a real mission control moment every time they get dressed. Paint it in fun colors, add decals, or even add little space stickers inside the drawers for that extra interstellar touch.</p>
                             ...
                             <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog12img3.png" alt="Interactive chalkboard cupboard" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>Okay, real talk: who doesn&#39;t love Narnia? We can&#39;t exactly step into a magical world of Aslan… but we can make your kid&#39;s cupboard feel like one (minus the freezing snow, thankfully).</p>
                              ...
                              <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog12img4.png" alt="Interactive chalkboard cupboard" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>Okay, confession: this one might actually be our favorite. For galaxy lovers and little astronauts, the Galaxy Glow Wardrobe is basically a dream come true. You can go with deep navy doors with glow-in-the-dark stars and planets.</p>
                             ...
                             <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog12img5.png" alt="Interactive chalkboard cupboard" className="w-full h-full object-cover" />
                            </div>

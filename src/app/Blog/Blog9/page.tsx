                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            <h2 className="text-2xl font-bold text-gray-900 pt-4">Starting With The Kitchen</h2>
                             ...
                             <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog9img1.png" alt="Nagaveni kitchen interior" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div className="relative w-[350px] h-[530]  rounded-xl overflow-hidden mt-3 ml-55">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog9img2.png" alt="Nagaveni pooja unit" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 pt-6">The TV Unit</h2>
                                ...
                                <div className="relative w-[300px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-60">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog9img3.png" alt="Nagaveni bedroom wardrobes" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 pt-6">The Two Bedroom Wardrobes</h2>
                                 ...
                                 <div className="relative w-[300px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-60">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog9img4.png" alt="Nagaveni bedroom wardrobes" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>Practicality was the theme, and we can happily say we achieved it (within 11 days). The inside of the first wardrobe had big horizontal shelves where Mr. Nagaveni&#39;s family could keep items, be they large or small.</p>
                                ...
                                <div className="relative w-[300px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-60">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog9img5.png" alt="Nagaveni bedroom wardrobes" className="w-full h-full object-cover" />
                            </div>

                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <div className="relative w-[580px] h-[580px] md:h-105 rounded-xl overflow-hidden mt-3 ml-30">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img1.png" alt="Circular rotating shelves wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <div>
                             <div className="relative w-[300px] h-[380px] rounded-xl overflow-hidden mt-3 ml-20">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img2.1.jpeg" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                                
                            </div>
                            <span>
                             <div className="relative w-[320] h-[380px]  rounded-xl overflow-hidden -mt-95 ml-100">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img2.2.jpeg" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                            </div>
                            </span>
                            </div>
                            ...
                            <p>Lighting isn&#39;t just for the room. It can make your wardrobe shine too! Ask your interior designers to add integrated LED strips in your wardrobe while building it to highlight your clothes, bags, and accessories, making it easier to pick the outfit, even in low light.</p>
                             <div className="relative w-[420] h-[750px]  rounded-xl overflow-hidden ml-40">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img3.jpeg" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>Instead of going with the basic wardrobe door, go with a translucent glass wardrobe door. This 2026 wardrobe trend lets light filter through while keeping your clothes and accessories subtly hidden, creating a perfect balance between privacy and display. Whether frosted, tinted, or patterned, translucent glass doors work with any setting.</p>
                                <div className="relative w-[420] h-[550px]  rounded-xl overflow-hidden ml-40">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img4.jpeg" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                            </div>
                            ...
                            <p>Maximize vertical wardrobe space with pull-down hanging rods to access clothes kept in upper sections without using a stool. It&#39;s practical, space-saving, and time-saving, making tall wardrobes fully usable while keeping everything organized. We at <span className="font-black text-black">HUB Interior</span> love incorporating these rods into tall or compact wardrobes to add additional space without sacrificing our client&#39;s style.</p>
                             <div className="relative w-[420] h-[550px]  rounded-xl overflow-hidden ml-40">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img5.png" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                            </div>                           
                            ...
                            <p>Who says your wardrobe is just for clothes? You can integrate a seating area in your wardrobe to use it while trying on shoes, folding outfits, or just wondering what you should wear next.</p>
                             <div className="relative w-[420] h-[550px]  rounded-xl overflow-hidden ml-40">
                                <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog13img6.png" alt="Push-to-open wardrobe" className="w-full h-full object-cover" />
                            </div>   

                ...
                <article className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-8">
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <p className="manrope-medium">The aim was not just to fill the space with furniture but to create interiors that simplify daily life. Each piece had to be functional, visually appealing, and easy to maintain. <span className="font-black text-black">HUB Interior</span> approached this <span className="font-black text-black">interior design project completion</span> with meticulous planning and attention to detail, ensuring no compromise on quality or timelines.</p>

                            <h2 className="text-2xl font-bold text-gray-900 pt-6 manrope">Kitchen Interiors That Balance Style and Utility</h2>
                            <p className="manrope-medium">The L-shaped kitchen was the heart of the project. Our team installed glass front kitchen cabinets, allowing Mrs. Anamika to keep essentials visible yet neatly organised. The slab kitchen cabinets added a modern edge, keeping the lines simple while providing generous storage.</p>
                            <p className="manrope-medium"><strong>Key features included:</strong> Smooth cabinet finishes for easy cleaning. Optimised storage solutions for cookware and utensils. Practical layouts that allow seamless movement while cooking. Integrated lighting to highlight both functionality and aesthetics.</p>
                            <p className="manrope-medium">The kitchen was designed to be inviting, bright, and highly functional – a space where cooking and interaction could happen simultaneously without feeling cluttered.</p>
                            
                            <div className="flex justify-center">
                                <div className="relative w-full max-w-[580px] h-auto rounded-xl overflow-hidden my-3">
                                    <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog16img1.png" alt="L-shaped kitchen design" className="w-full h-auto object-cover" />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-center items-center gap-4 my-3">
                                <div className="relative w-full max-w-[320px] h-auto rounded-xl overflow-hidden">
                                    <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog16img2.png" alt="Bedroom wardrobe design 1" className="w-full h-auto object-cover" />
                                </div>
                                <div className="relative w-full max-w-[320px] h-auto rounded-xl overflow-hidden">
                                    <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog16img3.png" alt="Bedroom wardrobe design 2" className="w-full h-auto object-cover" />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-center items-center gap-4 my-3">
                                <div className="relative w-full max-w-[320px] h-auto rounded-xl overflow-hidden">
                                    <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog16img4.png" alt="Living room interior 1" className="w-full h-auto object-cover" />
                                </div>
                                <div className="relative w-full max-w-[320px] h-auto rounded-xl overflow-hidden">
                                    <img src="https://urmwhawodjntegbbmnls.supabase.co/storage/v1/object/public/Hubinterior.img/blog16img5.png" alt="Living room interior 2" className="w-full h-auto object-cover" />
                                </div>
                            </div>
